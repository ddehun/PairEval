...
def get_args():
    ...
    parser.add_argument(
        "--comparison_type", type=str, default="random", choices=["random", "test"]
    )
    parser.add_argument("--adapter_path", type=str, default="ckpt/{}")
    parser.add_argument(
        "--base_model_path", type=str, default="llama-transformers/Llama-2-7b-chat-hf/"
    )
    parser.add_argument("--comparison_fname", type=str, default="data/shot/{}.{}.jsonl")
    parser.add_argument(
        "--eval_data_path", type=str, default="./data/evaluation/{data_name}.jsonl"
    )
    parser.add_argument(
        "--output_fname",
        type=str,
